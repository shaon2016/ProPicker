...
//        return file
        ...
        val savedImagePath: String = FileUriUtils.getRealPath(context, uri)!!
        var bmp = BitmapFactory.decodeFile(savedImagePath)
        ...
        bmp = checkRotation(savedImagePath, bmp, context)
        return bitmapToFile(context, bmp)
    }
